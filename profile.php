    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div class="mt-6 bg-slate-900/80 backdrop-blur-md border border-slate-700 rounded-none overflow-hidden relative group">
                ...
                <div class="p-4 relative z-10">
                    ...
                    <div class="mt-4 pt-3 border-t border-slate-700/50 text-center">
                        <a href="?id=<?php echo $profileId; ?>&tab=storage_info" class="text-[10px] text-slate-500 hover:text-cyan-400 transition-colors flex items-center justify-center gap-1 group/link">
        ...
        <div class="lg:col-span-2">
            ...
            <?php elseif ($tab === 'storage_info'): ?>
                <div class="bg-slate-800/30 border border-slate-700 rounded-none p-6 space-y-8 animate-fade-in">
                    ...
                    <div class="text-xs text-slate-500 text-center pt-4 border-t border-slate-700/50">
                        <p>A rendszer minden profilmegtekintéskor újrakalkulálja a limitet. A foglalt tárhely (`storage_used`) az adatbázisban kerül tárolásra.</p>
                    </div>
