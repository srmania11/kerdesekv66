...
--
-- Host: localhost
-- Generation Time: Feb 17, 2026 at 10:32 PM
...
(1, 1, 2, 'Szia! Ha a jövőállóság a cél, akkor az RX 7800 XT jó választás a 16GB VRAM miatt.', 1, 0, 0, NULL, 0, '2026-02-16 04:03:00'),
(2, 1, 3, 'Én az RTX 4070-et ajánlom a DLSS miatt.', 0, 0, 0, NULL, 2, '2026-02-16 04:03:00'),
...
(1, 2, 22, 'Milyen videókártyát vegyek 1440p gamingre?', 'milyen-videokartyat-vegyek-1440p-gamingre', 'Sziasztok! Építek egy új konfigot és elakadtam a videókártya választásnál. A célom a stabil 1440p felbontás és magas FPS.', 'solved', 0, 21, 0, NULL, 'Videókártya választás 1440p felbontáshoz.', '2026-02-16 04:03:00'),
(2, 3, 23, 'Hogyan lehet RAM-ot bővíteni laptopban?', 'hogyan-lehet-ram-ot-boviteni-laptopban', 'Segítséget szeretnék kérni. Van egy Lenovo Legion laptopom, és szeretnék bele még 8GB RAM-ot.', 'open', 0, 33, 0, NULL, 'RAM bővítés laptopban.', '2026-02-16 04:03:00'),
...
(5, 999, 22, 'rtze54z5z', 'rtze54z5z-65856', 'itt lesz szavazás ..<br><br>oké?', 'closed', 0, 23, 0, NULL, '', '2026-02-16 09:40:15'),
(6, 999, 21, 'erertgretre', 'erertgretre-617ba', 'retreterter', 'solved', 0, 27, 0, NULL, 'tretretret', '2026-02-16 11:10:19'),
(7, 999, 21, 'Legyünk kreatívak ...', 'legyunk-kreativak-a1878', 'oké<div>most</div><div>ide</div><div>fogok</div><div>írni</div><div>aha</div><div>oké</div>', 'solved', 0, 67, 0, NULL, 'röviden ...', '2026-02-16 12:04:06'),
(8, 999, 42, 'A Facebook hírfolyamon talált történetet később vissza tudom keresni valahol?', 'a-facebook-hirfolyamon-talalt-tortenetet-kesobb-vissza-tudom-keresni-valahol-2f0be', '<div>Tegnap olvastam egy érdekes történetet (olyat aminek a folytatása sok reklám után látható), szerettem volna elmenteni, vagy kimásolni, mert nagyon tetszett, ill. megosztani, de eltűnt. Sajnos nem tudom melyik csoportban volt.</div>', 'open', 0, 25, 0, NULL, '', '2026-02-16 21:59:05'),
...
(13, 999, 26, 'Képmegjelenítő szoftver helyett miért a böngésző nyitja meg a képet?', 'kepmegjelenito-szoftver-helyett-miert-a-bongeszo-nyitja-meg-a-kepet-80a5e', '<div>Microsoft Office 2007-ben táblázatba beszúrt kép alá hiperhivatkozástban az adott képet (ami albumban van) kellene megjelenítenie egy képszerkesztő (Fastone Viewer) szoftvernek.</div><div><br></div><div><br></div><div>Eddig semmi baj nem volt, működött hosszú időn keresztül, majd egyik napról a másikra a Chrome böngésző kezdte megnyitni a képet, és így az album sem jelenik meg, csak az adott kép.</div><div><br></div><div><br></div><div>Kipróbáltam Word-ben is, ugyanez a helyzet. Ha Intézőben, vagy Total Commanderben nyitom meg a képet, akkor a képszerkesztő nyitja meg, ahogy kell is.</div><div><br></div><div><br></div><div>A gépházban a Jpg, és jpeg formátumra (illetve az összes többire is) a képszerkesztő van alapértelmezettként beállítva, ellenőriztem akkor is, mikor a probléma előjött. A Chrome-nál nincs se a JPg, se a JPEG beállítva.</div><div><br></div><div><br></div><div>Mit csináljak, hogy ismét a képszerkesztő jelenítse meg, és nem a Chrome?</div><div><br></div><div><br></div><div>Újraraktam a képszerkesztőt, az Office-t, a Chrome-ot is, de nincs változás.</div><div><br></div><div><br></div><div>Operációs rendszer Win 11, újonnan telepítve (nem frissítve), hivatalosan lassan 1 éve.</div><div><br></div><div><br></div><div>Nem akarok másik Office-t telepíteni.</div>', 'open', 0, 12, 0, NULL, '', '2026-02-16 22:32:37'),
(14, 999, 21, 'Melyek voltak a történelem legrosszabb processzorai?', 'melyek-voltak-a-tortenelem-legrosszabb-processzorai-9af54', 'Jöhet hideg és meleg... :)', 'open', 0, 15, 0, NULL, '', '2026-02-16 22:35:47'),
(15, 999, 26, 'Parancssorba beírtam a chkdsk C: /f /r parancsot ami elvileg kijavít C meghajtó hibákat de \" acess denied\" mi a gond?', 'parancssorba-beirtam-a-chkdsk-c-f-r-parancsot-ami-elvileg-kijavit-c-meghajto-hibakat-de-acess-denied-mi-a-gond-b63f3', '<div>biztonsági mentést akarnék csinálni de kiírta hogy hibás C meghajtó, újraindítottam ahogy kérte de nem javított ki semmit (még 2x megismételtem továbbra is fennáll a hiba)</div><div><br></div><div>a parancssorba beírtam ezt az állítólagos kódot \"chkdsk C: /f /r\", de nem enged tovább</div><div><br></div><div>rosszul adtam meg a parancsot? rendszergazdák nevethetnek és segíthetnének please</div><div><br></div><div>(1 éve van saját gépem, apa engedte és egy részét én fizettem diákmunkával. de nem vagyok pc zseni. 😥 Gigabyte kártya, és amd processzor)</div><div><br></div>', 'open', 0, 8, 0, NULL, '', '2026-02-16 23:13:25'),
...
(17, 999, 26, 'Képmegjelenítő szoftver helyett miért a böngésző nyitja meg a képet?', 'kepmegjelenito-szoftver-helyett-miert-a-bongeszo-nyitja-meg-a-kepet-4899f', 'Na, miért ?', 'open', 0, 3, 0, NULL, '', '2026-02-17 08:01:39'),
(18, 999, 21, 'teszt', 'teszt-315df', 'teszt', 'open', 0, 3, 0, NULL, '', '2026-02-17 08:16:07'),
(19, 999, 28, 'Van olyan antivirus vagy egyébb program amely észreveszi ha a windowson hiányoznak biztonsági frissitések?', 'van-olyan-antivirus-vagy-egyebb-program-amely-eszreveszi-ha-a-windowson-hianyoznak-biztonsagi-frissitesek-781e7', '<div>Sajnos a Windows automatikus frissités nem működik.</div>', 'open', 0, 1, 0, NULL, 'A Nessus Home vagy a Qualys Free Scan ingyenesen ellenőrzi a hiányzó frissítéseket. Nem vírusírtó, de biztonsági rést mutat.', '2026-02-17 09:35:24'),
(20, 999, 50, 'Avast mellé kell más biztonsági cucc?', 'avast-melle-kell-mas-biztonsagi-cucc-9d39a', '<div>Ajánlotok valamit?</div>', 'open', 0, 2, 0, NULL, '', '2026-02-17 09:45:49');
...
INSERT INTO `qc_users` (`user_id`, `username`, `reputation_points`, `custom_title`, `is_admin`, `created_at`) VALUES
(1, 'Admin', 1000, 'Adminisztrátor', 1, '2026-02-16 04:03:00'),
(2, 'TechGuru', 500, 'Hardver Szakértő', 0, '2026-02-16 04:03:00'),
(3, 'Gamer99', 150, 'Haladó Tag', 0, '2026-02-16 04:03:00'),
(999, 'TestUser', 50, 'Kezdő Tag', 0, '2026-02-16 04:03:00');
